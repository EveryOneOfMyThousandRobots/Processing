...
String[] vowels = {"e", "e", "e", "e", "a", "e", "i", "o", "u", "ea", "ea", "ai","ai", "ou", "oa", "y", "ee"};
String[] cons = {"no", "pla", "pl", "b", "b", "b", "c", "d", "f", "g", "h", "j", "k", "l", "m", "n", "n", "s", "r", "t", "p", "qu", "r", "rh", "s", "t", "v", "w", "z"};
String[] midCons = {"mb","f", "s","lt","lm", "ll", "ss", "st", "str", "gh", "zz", "mm", "ck", "rs", "rst", "nt", "ls", "ns"};
String[] endCons = {"lm", "ns", "nt", "l", "ll", "s", "stry", "try", "rsty", "n", "b", "t", "tt", "p", "r", "r", "en", "man", "int", "ent", "ount"};
