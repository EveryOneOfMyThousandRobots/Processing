...
import processing.opengl.PGraphics2D;
  ...
  //
  // Chains, made of Circle-Bodies connected through DistanceJoints are randomly
  // places in a scene and interact with randomly falling rigid bodies, as well
  // as particles.
  // 
  // 
  // required libraries:
  ...
  public void reset(){
    ...
    world.mouse_drag_bodies.enable_static_drag = true;
